...
declare namespace ts {
    ...
    export enum SyntaxKind {
        ...
        JSDocMemberName = 307,
        JSDocAllType = 308,
        JSDocUnknownType = 309,
        JSDocNullableType = 310,
        JSDocNonNullableType = 311,
        JSDocOptionalType = 312,
        JSDocFunctionType = 313,
        JSDocVariadicType = 314,
        JSDocNamepathType = 315,
        JSDocComment = 316,
        JSDocText = 317,
        ...
        JSDocPublicTag = 329,
        JSDocPrivateTag = 330,
        JSDocProtectedTag = 331,
        JSDocReadonlyTag = 332,
        JSDocOverrideTag = 333,
        JSDocCallbackTag = 334,
        JSDocEnumTag = 335,
        JSDocParameterTag = 336,
        JSDocReturnTag = 337,
        JSDocThisTag = 338,
        JSDocTypeTag = 339,
        JSDocTemplateTag = 340,
        JSDocTypedefTag = 341,
        JSDocSeeTag = 342,
        JSDocPropertyTag = 343,
        SyntaxList = 344,
        NotEmittedStatement = 345,
        PartiallyEmittedExpression = 346,
        CommaListExpression = 347,
        MergeDeclarationMarker = 348,
        EndOfDeclarationMarker = 349,
    ...
    export type Modifier = AbstractKeyword | AsyncKeyword | ConstKeyword | DeclareKeyword | DefaultKeyword | ExportKeyword | PrivateKeyword | ProtectedKeyword | PublicKeyword | FinalKeyword | OverrideKeyword | ReadonlyKeyword | StaticKeyword;
